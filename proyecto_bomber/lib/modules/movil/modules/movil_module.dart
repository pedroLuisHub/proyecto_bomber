...
import 'package:bomber/modules/movil/pages/movil_reporte.dart';
import 'package:bomber/modules/movil/pages/movil_selector_page.dart';
...
class MovilModule extends Module {
  ...
  void routes(RouteManager r) {
    ...
    r.child('/select', child: (_) => MovilSelectorPage());
    r.child('/reporte_movil', child: (_) => ReporteMovil());
  }
}
